...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ExerciseAction.exercise'
        db.alter_column(u'chinesetool_exerciseaction', 'exercise_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chinesetool.ExerciseCommon']))

        # Changing field 'WordPLExercise.exercise'
        db.alter_column(u'chinesetool_wordplexercise', 'exercise_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chinesetool.ExerciseCommon']))

        # Changing field 'SentenceZHExercise.exercise'
        db.alter_column(u'chinesetool_sentencezhexercise', 'exercise_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chinesetool.ExerciseCommon']))

        # Changing field 'WordZHExercise.exercise'
        db.alter_column(u'chinesetool_wordzhexercise', 'exercise_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chinesetool.ExerciseCommon']))

        # Changing field 'ExplanationExercise.exercise'
        db.alter_column(u'chinesetool_explanationexercise', 'exercise_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chinesetool.ExerciseCommon']))

        # Changing field 'SentencePLExercise.exercise'
        db.alter_column(u'chinesetool_sentenceplexercise', 'exercise_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chinesetool.ExerciseCommon']))
