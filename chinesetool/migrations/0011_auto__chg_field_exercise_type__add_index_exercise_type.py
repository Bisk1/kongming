...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Exercise.type' to match new field type.
        db.rename_column(u'chinesetool_exercise', 'type', 'type_id')
        # Changing field 'Exercise.type'
        db.alter_column(u'chinesetool_exercise', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chinesetool.ExerciseType']))
        # Adding index on 'Exercise', fields ['type']
        db.create_index(u'chinesetool_exercise', ['type_id'])


    def backwards(self, orm):
        # Removing index on 'Exercise', fields ['type']
        db.delete_index(u'chinesetool_exercise', ['type_id'])


        # Renaming column for 'Exercise.type' to match new field type.
        db.rename_column(u'chinesetool_exercise', 'type_id', 'type')
        # Changing field 'Exercise.type'
        db.alter_column(u'chinesetool_exercise', 'type', self.gf('django.db.models.fields.CharField')(max_length=1))
