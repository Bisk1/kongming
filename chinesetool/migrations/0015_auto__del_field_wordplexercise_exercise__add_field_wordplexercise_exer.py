...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WordPLExercise.exercise_common'
        ...
        # Adding field 'SentenceZHExercise.exercise_common'
        ...
        # Adding field 'WordZHExercise.exercise_common'
        ...
        # Adding field 'ExplanationExercise.exercise_common'
        ...
        # Adding field 'SentencePLExercise.exercise_common'
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'WordPLExercise.exercise'
        raise RuntimeError("Cannot reverse this migration. 'WordPLExercise.exercise' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'WordPLExercise.exercise'
        ...
        # User chose to not deal with backwards NULL issues for 'SentenceZHExercise.exercise'
        raise RuntimeError("Cannot reverse this migration. 'SentenceZHExercise.exercise' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SentenceZHExercise.exercise'
        ...
        # User chose to not deal with backwards NULL issues for 'WordZHExercise.exercise'
        raise RuntimeError("Cannot reverse this migration. 'WordZHExercise.exercise' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'WordZHExercise.exercise'
        ...
        # User chose to not deal with backwards NULL issues for 'ExplanationExercise.exercise'
        raise RuntimeError("Cannot reverse this migration. 'ExplanationExercise.exercise' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ExplanationExercise.exercise'
        ...
        # User chose to not deal with backwards NULL issues for 'SentencePLExercise.exercise'
        raise RuntimeError("Cannot reverse this migration. 'SentencePLExercise.exercise' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SentencePLExercise.exercise'
    ...
    models = {
        ...
        u'chinesetool.explanationexercise': {
            ...
            'exercise_common': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['chinesetool.ExerciseCommon']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
