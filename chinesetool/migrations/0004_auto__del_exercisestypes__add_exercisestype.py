...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ExercisesTypes'
        db.delete_table(u'chinesetool_exercisestypes')

        # Adding model 'ExercisesType'
        db.create_table(u'chinesetool_exercisestype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='NO-NAME', max_length=100)),
        ))
        db.send_create_signal(u'chinesetool', ['ExercisesType'])


    def backwards(self, orm):
        # Adding model 'ExercisesTypes'
        db.create_table(u'chinesetool_exercisestypes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='NO-NAME', max_length=100)),
        ))
        db.send_create_signal(u'chinesetool', ['ExercisesTypes'])

        # Deleting model 'ExercisesType'
        db.delete_table(u'chinesetool_exercisestype')
    ...
    models = {
        ...
        u'chinesetool.exercisestype': {
            'Meta': {'object_name': 'ExercisesType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'NO-NAME'", 'max_length': '100'})
        },
