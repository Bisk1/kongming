...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exercise.number'
        db.alter_column(u'chinesetool_exercise', 'number', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Exercise.number'
        db.alter_column(u'chinesetool_exercise', 'number', self.gf('django.db.models.fields.IntegerField')())
