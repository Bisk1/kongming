...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExerciseType.description'
        db.add_column(u'chinesetool_exercisetype', 'description',
                      self.gf('django.db.models.fields.CharField')(default='NO-DESC', max_length=100),
                      keep_default=False)


        # Changing field 'ExerciseType.name'
        db.alter_column(u'chinesetool_exercisetype', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):
        # Deleting field 'ExerciseType.description'
        db.delete_column(u'chinesetool_exercisetype', 'description')


        # Changing field 'ExerciseType.name'
        db.alter_column(u'chinesetool_exercisetype', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'chinesetool.exercisetype': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'NO-NAME'", 'max_length': '10'})
        },
