...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WordZH.lesson'
        db.delete_column(u'chinesetool_wordzh', 'lesson_id')


    def backwards(self, orm):
        # Adding field 'WordZH.lesson'
        db.add_column(u'chinesetool_wordzh', 'lesson',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['chinesetool.Lesson'], null=True),
                      keep_default=False)
