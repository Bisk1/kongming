...
class PlaceholdersWindow(Window):
    ...
    def record_audio(self, placeholder_name):
        record_button_xpath = self.get_button_xpath(placeholder_name)
        start_button_xpath = record_button_xpath  # same xpath anyway
        stop_button_xpath = record_button_xpath   # and here
        confirm_button_xpath = record_button_xpath   # and here
    ...
    def get_button_xpath(self, placeholder_name):
