...
class LearnView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if operation == ExerciseOperation.CHECK.value:
            ...
            if lesson_action.has_next() and lesson_action.status != Status.failure.value:
    ...
    def get(self, request, *args, **kwargs):
        ...
        to_delete = LessonAction.objects.filter(user=request.user, lesson=lesson, status=Status.not_done.value)
        to_delete.delete()
