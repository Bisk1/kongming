var LessonsMapGenerator = (function () {
    ...
    var statusImage = function(status) {
        if (status == STATUS.SUCCESS.value) {
            return Django.static("learn/img/book_green.png");
        } else if (status == STATUS.FAILURE.value) {
            return Django.static("learn/img/book_red.png");
        } else if (status == STATUS.NOT_DONE.value) {
            return Django.static("learn/img/book_blue.png");
        } else {
            return Django.static("learn/img/book_gray.png");
        }
    };
